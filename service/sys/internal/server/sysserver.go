...
import (
	...
	"zdmin/service/sys/internal/logic"
...
func (s *SysServer) UserRoleUpdate(ctx context.Context, in *sys.UserRoleUpdateReq) (*sys.UserRoleUpdateResp, error) {
...
func (s *SysServer) UserStatusUpdate(ctx context.Context, in *sys.UserStatusReq) (*sys.UserStatusResp, error) {
	l := logic.NewUserStatusUpdateLogic(ctx, s.svcCtx)
	return l.UserStatusUpdate(in)
}
...
func (s *SysServer) RoleRoleUpdate(ctx context.Context, in *sys.RoleRoleUpdateReq) (*sys.RoleRoleUpdateResp, error) {
	l := logic.NewRoleRoleUpdateLogic(ctx, s.svcCtx)
	return l.RoleRoleUpdate(in)
}
...
func (s *SysServer) MenuRoleUpdate(ctx context.Context, in *sys.MenuRoleUpdateReq) (*sys.MenuRoleUpdateResp, error) {
	l := logic.NewMenuRoleUpdateLogic(ctx, s.svcCtx)
	return l.MenuRoleUpdate(in)
}
...
func (s *SysServer) ConfigRoleUpdate(ctx context.Context, in *sys.ConfigRoleUpdateReq) (*sys.ConfigRoleUpdateResp, error) {
	l := logic.NewConfigRoleUpdateLogic(ctx, s.svcCtx)
	return l.ConfigRoleUpdate(in)
}
