...
func (l *FlashPromotionSessionUpdateLogic) FlashPromotionSessionUpdate(req types.UpdateFlashPromotionSessionReq) (
	*types.UpdateFlashPromotionSessionResp,
	error,
) {
	_, err := l.svcCtx.Sms.FlashPromotionSessionUpdate(
		l.ctx, &smsclient.FlashPromotionSessionUpdateReq{
			Id:         req.Id,
			Name:       req.Name,
