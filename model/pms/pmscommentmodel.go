...
var (
	pmsCommentFieldNames          = builderx.RawFieldNames(&PmsComment{})
...
func (m *PmsCommentModel) Insert(data PmsComment) (sql.Result, error) {
	...
	ret, err := m.conn.Exec(query, data.ProductId, data.MemberNickName, data.ProductName, data.Star, data.MemberIp, data.ShowStatus, data.ProductAttribute, data.CollectCount, data.ReadCount, data.Content, data.Pics, data.MemberIcon, data.ReplayCount)
	return ret, err
}
...
func (m *PmsCommentModel) Update(data PmsComment) error {
	...
	_, err := m.conn.Exec(query, data.ProductId, data.MemberNickName, data.ProductName, data.Star, data.MemberIp, data.ShowStatus, data.ProductAttribute, data.CollectCount, data.ReadCount, data.Content, data.Pics, data.MemberIcon, data.ReplayCount, data.Id)
	return err
}
